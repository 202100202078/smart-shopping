<template>
  <div class="order-list-item" v-if="order.order_id">
    <div class="tit">
    ...
    <div class="list">
      <div class="list-item" v-for="goods in order.goods" :key="goods.goods_id">
        <div class="goods-img">
    ...
    <div class="total">
      共{{order.total_num}}件商品，总金额 ¥{{order.total_price}}
    </div>
    <div class="actions">
